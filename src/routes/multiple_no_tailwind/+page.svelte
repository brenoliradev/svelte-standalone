<script lang="ts">
	...
	const generateInstance = () => {
		const i = window.multiple_no_tailwind.start(defaultConfig);
...
<svelte:head>
	<script type="module" src="/dist/standalone/multiple_no_tailwind.min.js"></script>
</svelte:head>
...
<main class="p-2">
	<button
		...
		on:click={generateInstance}>init instance of multiple_no_tailwind</button
	>
