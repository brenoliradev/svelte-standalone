 ...
 */
export function generateEmbedFiles(componentName: string, embedType: string, strategy: string | undefined): Promise<void>;
/**
 ...
 */
export function generateTypesFile(componentName: string, strategy: string | undefined): Promise<void>;
/**
